...
jQuery(document).ready(function($) {
		$('.my-archive ul.day:gt(2)').hide();//display line 0 and 1
		$('.my-archive ul.month').click(function() {//click title action
		$('.my-archive ul.day').slideUp(300);//slide up ul
		$(this).next('ul').slideDown(500);//slide other brothers
		});
		//一下是全局的操作
		$('#control').toggle(
		function(){
